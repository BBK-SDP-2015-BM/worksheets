...
public class HelloWorldSpringWithDIXMLFileConstructorArgument {
    ...
    // bean factory spring boilerplate code from configurable xml
    private static BeanFactory getBeanFactory() throws Exception {

        // create bean factory from beans.xml (note use of file: to find beans??)
        BeanFactory factory = new ClassPathXmlApplicationContext("file:/Users/Basil/IdeaProjects/worksheets/src/com/sdp/helloworld/spring/xml/constructor/beans.xml");
        return factory;
    }
